    ...
    public partial class FormAllPlayer : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                this.textBoxMajor.Text = selectedPlayer.Major;
                this.textBoxGname.Text = selectedPlayer.Gname;

            }
            string iName = textBoxName.Text, iLname = "", iID = textBoxID.Text, iMajor = textBoxMajor.Text, iGname = textBoxGname.Text, iMail = "", iTel = "", age = "0";
            int iage = Int32.Parse(age);
            selectedPlayer = new Player(iName, iLname, iID, iMajor, iGname, iMail, iTel, iage);
        }
